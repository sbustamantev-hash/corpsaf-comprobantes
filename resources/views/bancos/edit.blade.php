...
@section('subtitle', 'Modificar datos del banco')
        ...
        <form action="{{ route('bancos.update', $banco->id) }}" method="POST">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           value="{{ old('descripcion', $banco->descripcion) }}" 
                           required>
                    @error('descripcion')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
            ...
            <div class="mt-6 flex items-center justify-end space-x-4">
                ...
                <button type="submit" 
                    ...
                    <i class="fas fa-save mr-2"></i>Actualizar Banco
                </button>
            </div>
        </form>
    </div>
