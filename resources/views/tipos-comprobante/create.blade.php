...
@section('title', 'Nuevo Tipo de Comprobante')
@section('subtitle', 'Crear un nuevo tipo de comprobante')

@section('content')
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <form action="{{ route('tipos-comprobante.store') }}" method="POST">
            @csrf
            ...
            <div class="space-y-6">
                <div>
                    ...
                    @enderror
                    <p class="mt-1 text-xs text-gray-500">Código único para identificar el tipo de comprobante</p>
                </div>
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           required
                           placeholder="Ej: Factura, Boleta de Venta, Recibo por Honorarios">
                    @error('descripcion')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
