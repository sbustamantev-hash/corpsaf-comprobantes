                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="dni"
                                ...
                                value="{{ old('dni') }}" required maxlength="20" placeholder="Ej: 12345678">
                            @error('dni')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="text" name="telefono"
                                ...
                                value="{{ old('telefono') }}" maxlength="20" placeholder="Ej: 987654321">
                            @error('telefono')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div>
                        ...
                        <input type="email" name="email"
                            ...
                            value="{{ old('email') }}" required placeholder="Ej: usuario@corpsaf.com">
                        @error('email')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <select name="role" required
                            ...
                            <option value="area_admin" {{ old('role') == 'area_admin' ? 'selected' : '' }}>Administrador de
                                Empresa</option>
                            <option value="operador" {{ old('role') == 'operador' ? 'selected' : '' }}>Usuario / Trabajador
                            </option>
                        </select>
                        @error('role')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
