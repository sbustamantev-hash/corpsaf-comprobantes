                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="dni"
                                ...
                                value="{{ old('dni', $user->dni) }}" required maxlength="20" placeholder="Ej: 12345678">
                            @error('dni')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="telefono"
                                ...
                                value="{{ old('telefono', $user->telefono) }}" maxlength="20" placeholder="Ej: 987654321">
                            @error('telefono')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div>
                        ...
                        <input type="email" name="email"
                            ...
                            value="{{ old('email', $user->email) }}" required placeholder="Ej: usuario@corpsaf.com">
                        @error('email')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <select name="role" required
                            ...
                            <option value="area_admin" {{ old('role', $user->role) == 'area_admin' ? 'selected' : '' }}>
                                Administrador de Empresa</option>
                            <option value="operador" {{ old('role', $user->role) == 'operador' ? 'selected' : '' }}>Usuario /
                                Trabajador</option>
                        </select>
                        @error('role')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
