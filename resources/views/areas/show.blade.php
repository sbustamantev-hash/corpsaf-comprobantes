...
@section('title', 'Detalles del Empresa')
@section('subtitle', 'Información del Empresa')
...
@section('content')
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <!-- Usuarios del Empresa -->
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between mb-4">
                <h3 class="text-lg font-semibold text-gray-900">Usuarios del Empresa</h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select name="role" 
                                ...
                                <option value="area_admin" {{ old('role') == 'area_admin' ? 'selected' : '' }}>Administrador de Empresa</option>
            ...
            @else
                <p class="text-gray-500 text-center py-4">No hay usuarios asignados a esta Empresa</p>
            @endif
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <select name="role" 
                                            ...
                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('role') border-red-500 @enderror">
                                        <option value="">Seleccione un rol</option>
                                        <option value="area_admin" {{ old('role', $user->role) == 'area_admin' ? 'selected' : '' }}>Administrador de Empresa</option>
