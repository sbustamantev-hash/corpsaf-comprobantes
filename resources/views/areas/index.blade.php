...
@section('title', 'Áreas/Empresas')
@section('subtitle', 'Gestión de áreas y empresas')
...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-bold text-gray-900">Áreas/Empresas</h2>
            <p class="text-gray-600 mt-1">Gestiona las áreas y empresas del sistema</p>
        </div>
