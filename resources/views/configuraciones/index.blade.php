        ...
        <form action="{{ route('configuraciones.update') }}" method="POST" enctype="multipart/form-data" class="p-6">
            ...
            <div class="mb-6">
                ...
                <input type="text"
                    id="nombre_app"
                    name="nombre_app"
                    value="{{ old('nombre_app', $nombreApp) }}"
            ...
            <div class="mb-6 p-6 bg-gray-50 rounded-lg border border-gray-200">
                ...
                <div class="bg-white rounded-lg p-6 shadow-sm">
                    <div class="text-center">
                        <div class="inline-flex items-center justify-center w-16 h-16 bg-blue-600 rounded-xl mb-4 overflow-hidden">
                            @if($logoPath)
                                <img src="{{ asset('storage/' . $logoPath) }}" 
                                     alt="Logo" 
